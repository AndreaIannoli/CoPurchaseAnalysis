...
upload_file "bucket_copurchase" "../orderaffinity/src/order_products.csv" "order_products.csv"
upload_file "bucket_copurchase" "../orderaffinity/src/order_products.csv" "orderaffinity_2.12-0.1.0.jar"
